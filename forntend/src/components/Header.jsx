...
function Header() {
  return (
    <header className="fixed top-0 left-0 z-50 w-full bg-gray-100 shadow-sm">
      <nav className="container flex justify-center items-center px-6 py-4 mx-auto">
        <div className="absolute left-6">
          <Link to="/">
            <h1 className="flex text-4xl font-extrabold text-black">Lace UP</h1>
          </Link>
        </div>
        <ul className="flex justify-center space-x-8 font-medium text-center text-black">
          <li>
        ...
        <div className="flex absolute right-6 items-center space-x-4 text-xl text-black">
          ...
          <button title="Sign in" className="hover:text-gray-600">
            Sign IN
          </button>
        </div>
      </nav>
